...
import { IDEXSwapFactory } from "./interfaces/IDEXSwapFactory.sol";
import { DEXSwapPoolDeployer } from "./DEXSwapPoolDeployer.sol";
import { IDEXSwapPool } from "./interfaces/IDEXSwapPool.sol";

contract DEXSwapFactory is IDEXSwapFactory, DEXSwapPoolDeployer, Ownable {
    ...
    function updateFee(address tokenA, address tokenB, uint24 newFee) external onlyOwner {
        ...
        _fees[pool] = newFee;
        IDEXSwapPool(pool).updateFee(newFee);
    }
}